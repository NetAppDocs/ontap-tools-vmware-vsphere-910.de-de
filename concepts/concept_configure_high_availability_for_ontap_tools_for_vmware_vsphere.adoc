...
https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability.html["VMware vSphere Dokumentation: Erstellen und Verwenden von vSphere HA-Clustern"^]
