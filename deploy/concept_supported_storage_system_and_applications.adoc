...
https://imt.netapp.com/matrix/imt.jsp?components=103229;&solution=1777&isHWU&src=IMT["Interoperabilitäts-Matrix-Tool"]
...
* https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-resource-management.html["Anforderungen an die Storage-I/O-Kontrolle"^]
